...
mixin CompileRequestMappable {
  ...
  get copyWith => _CompileRequestCopyWithImpl<CompileRequest, CompileRequest>(
    this as CompileRequest,
    $identity,
    $identity,
  );
...
mixin CompileResponseMappable {
  String toJson() {
    return CompileResponseMapper.ensureInitialized()
        .encodeJson<CompileResponse>(this as CompileResponse);
  }
...
mixin AnalyzeRequestMappable {
  ...
  get copyWith => _AnalyzeRequestCopyWithImpl<AnalyzeRequest, AnalyzeRequest>(
    this as AnalyzeRequest,
    $identity,
    $identity,
  );
...
mixin FormatResponseMappable {
  ...
  get copyWith => _FormatResponseCopyWithImpl<FormatResponse, FormatResponse>(
    this as FormatResponse,
    $identity,
    $identity,
  );
...
mixin FormatRequestMappable {
  ...
  get copyWith => _FormatRequestCopyWithImpl<FormatRequest, FormatRequest>(
    this as FormatRequest,
    $identity,
    $identity,
  );
...
mixin AnalyzeResponseMappable {
  String toJson() {
    return AnalyzeResponseMapper.ensureInitialized()
        .encodeJson<AnalyzeResponse>(this as AnalyzeResponse);
  }
...
extension IssueValueCopy<$R, $Out> on ObjectCopyWith<$R, Issue, $Out> {
  IssueCopyWith<$R, Issue, $Out> get $asIssue =>
      $base.as((v, t, t2) => _IssueCopyWithImpl<$R, $Out>(v, t, t2));
}
...
mixin IssueLocationMappable {
  ...
  get copyWith => _IssueLocationCopyWithImpl<IssueLocation, IssueLocation>(
    this as IssueLocation,
    $identity,
    $identity,
  );
...
mixin DocumentResponseMappable {
  String toJson() {
    return DocumentResponseMapper.ensureInitialized()
        .encodeJson<DocumentResponse>(this as DocumentResponse);
  }

  Map<String, dynamic> toMap() {
    return DocumentResponseMapper.ensureInitialized()
        .encodeMap<DocumentResponse>(this as DocumentResponse);
  }
...
mixin HoverInfoMappable {
  ...
  HoverInfoCopyWith<HoverInfo, HoverInfo, HoverInfo> get copyWith =>
      _HoverInfoCopyWithImpl<HoverInfo, HoverInfo>(
        this as HoverInfo,
        $identity,
        $identity,
      );
...
mixin DocumentRequestMappable {
  String toJson() {
    return DocumentRequestMapper.ensureInitialized()
        .encodeJson<DocumentRequest>(this as DocumentRequest);
  }
