...
class WeatherLocation {
  ...
  WeatherLocation.fromJson(Map<String, dynamic> json) : name = json['name'], country = json['country'];
}
...
class WeatherCondition {
  ...
  WeatherCondition.fromJson(Map<String, dynamic> json) : text = json['text'], icon = json['icon'];
}
