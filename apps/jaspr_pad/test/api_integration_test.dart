...
import 'package:jaspr_pad/main.server.dart';
import 'package:jaspr_pad/main.server.init.dart';
  ...
  group('API Integration Tests', () {
    test('/api/compile rejects absolute path in sources', () async {
      ...
      final payload = jsonEncode({
        'sources': {'/tmp/jasprpad-afw-poc': 'ARBITRARY-FILE-WRITE-PoC', 'main.dart': 'void main() {}'},
      });
    ...
    test('/api/download rejects absolute path in sources', () async {
      ...
      final projectData = {
        ...
        'dartFiles': {'/tmp/jasprpad-afw-poc': 'ARBITRARY-FILE-WRITE-PoC'},
      };
