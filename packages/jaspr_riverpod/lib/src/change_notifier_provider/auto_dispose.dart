...
abstract class AutoDisposeChangeNotifierProviderRef<Notifier> implements AutoDisposeRef<Notifier> {
...
@sealed
class AutoDisposeChangeNotifierProvider<Notifier extends ChangeNotifier?> extends AutoDisposeProviderBase<Notifier>
    with
        ChangeNotifierProviderOverrideMixin<Notifier>,
        OverrideWithProviderMixin<Notifier, AutoDisposeChangeNotifierProvider<Notifier>> {
  /// {@macro riverpod.changenotifierprovider}
  ...
  @override
  AutoDisposeProviderElement<Notifier> createElement() => AutoDisposeProviderElement(this);
}

// ignore: subtype_of_sealed_class
class _AutoDisposeNotifierProvider<Notifier extends ChangeNotifier?> extends AutoDisposeProviderBase<Notifier> {
  ...
  final Create<Notifier, AutoDisposeChangeNotifierProviderRef<Notifier>> _create;
...
class _AutoDisposeNotifierProviderElement<Notifier extends ChangeNotifier?>
    extends AutoDisposeProviderElementBase<Notifier> implements AutoDisposeChangeNotifierProviderRef<Notifier> {
  _AutoDisposeNotifierProviderElement(_AutoDisposeNotifierProvider<Notifier> provider) : super(provider);
...
@sealed
class AutoDisposeChangeNotifierProviderFamily<Notifier extends ChangeNotifier?, Arg>
  ...
  final FamilyCreate<Notifier, AutoDisposeChangeNotifierProviderRef<Notifier>, Arg> _create;
