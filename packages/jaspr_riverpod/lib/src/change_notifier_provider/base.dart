...
abstract class ChangeNotifierProviderRef<Notifier extends ChangeNotifier?> implements Ref<Notifier> {
...
@sealed
class ChangeNotifierProvider<Notifier extends ChangeNotifier?> extends AlwaysAliveProviderBase<Notifier>
    with
...
// ignore: subtype_of_sealed_class
class _NotifierProvider<Notifier extends ChangeNotifier?> extends AlwaysAliveProviderBase<Notifier> {
  _NotifierProvider(
    this._create, {
...
class _NotifierProviderElement<Notifier extends ChangeNotifier?> extends ProviderElementBase<Notifier>
    implements ChangeNotifierProviderRef<Notifier> {
  _NotifierProviderElement(_NotifierProvider<Notifier> provider) : super(provider);
...
class ChangeNotifierProviderFamily<Notifier extends ChangeNotifier?, Arg>
  ...
  final FamilyCreate<Notifier, ChangeNotifierProviderRef<Notifier>, Arg> _create;
