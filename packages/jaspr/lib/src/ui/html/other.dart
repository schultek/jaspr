...
Component link({required String href, String? rel, String? type, String? as, Key? key, String? id, List<String>? classes, Styles? styles, Map<String, String>? attributes, Map<String, EventCallback>? events}) {
  return DomComponent(
    tag: 'link',
    key: key,
    id: id,
...
Component script(List<Component> children, {bool? async, bool? defer, required String src, Key? key, String? id, List<String>? classes, Styles? styles, Map<String, String>? attributes, Map<String, EventCallback>? events}) {
  return DomComponent(
    tag: 'script',
    key: key,
    id: id,
