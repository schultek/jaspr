...
class Jaspr {
  ...
  static ClientOptions get options => _options ?? ClientOptions();
  static ClientOptions? _options;

}

/// Global options for configuring Jaspr on the client. DO NOT USE DIRECTLY.
...
/// The loader configuration for a @client component. DO NOT USE DIRECTLY.
/// Use the generated [defaultClientOptions] instead.
class ClientLoader {
  ...
  FutureOr<ClientBuilder> get loadedBuilder {
    _loadedBuilder ??= loader != null ? loader!().then((_) {
...
/// The builder function type for a @client component. DO NOT USE DIRECTLY.
/// Use the generated [defaultClientOptions] instead.
