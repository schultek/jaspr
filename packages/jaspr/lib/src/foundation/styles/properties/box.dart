...
///
/// Use this API to set an element's border. The default constructor creates
/// borders (width/style/color) for all sides, or you can use [Border.only] 
/// and [Border.symmetric] to configure individual sides with [BorderSide]. 
/// Omitted sub-values fall back to initial CSS values.
abstract class Border {
  /// Create a border with the given style, color, and width for all sides.
...
class BorderSide {
  ...
  /// Create a dotted border side with the given color and width.
  const BorderSide.dotted({this.color, this.width}) : style = BorderStyle.dotted;
  /// Create a dashed border side with the given color and width.
  const BorderSide.dashed({this.color, this.width}) : style = BorderStyle.dashed;
  /// Create a double border side with the given color and width.
  const BorderSide.double({this.color, this.width}) : style = BorderStyle.double;
  /// Create a groove border side with the given color and width.
  const BorderSide.groove({this.color, this.width}) : style = BorderStyle.groove;
  /// Create a ridge border side with the given color and width.
...
class Cursor {
  ...
  /// 
  /// ![context-menu](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/context-menu.png)
  ...
  /// 
  /// ![vertical-text](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/vertical-text.gif)
  ...
  /// 
  /// ![no-drop](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/no-drop.gif)
  static const Cursor noDrop = Cursor._('no-drop');
  /// The requested action will not be carried out.
  /// 
  /// ![not-allowed](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/not-allowed.gif)
  ...
  /// 
  /// ![all-scroll](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/all-scroll.gif)
  ...
  /// 
  /// ![col-resize](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor/col-resize.gif)
