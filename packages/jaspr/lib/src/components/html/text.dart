...
/// {@endtemplate}
class b extends StatelessComponent {
  /// {@macro jaspr.html.b}
  const b(
    this.children, {
    this.id,
...
/// {@endtemplate}
class code extends StatelessComponent {
...
/// {@endtemplate}
class em extends StatelessComponent {
  /// {@macro jaspr.html.em}
  const em(
    this.children, {
    this.id,
...
/// {@endtemplate}
class i extends StatelessComponent {
  /// {@macro jaspr.html.i}
  const i(
    this.children, {
    this.id,
...
/// {@endtemplate}
class s extends StatelessComponent {
  /// {@macro jaspr.html.s}
  const s(
    this.children, {
    this.id,
...
/// {@endtemplate}
class small extends StatelessComponent {
...
/// {@endtemplate}
class span extends StatelessComponent {
...
/// {@endtemplate}
class strong extends StatelessComponent {
...
/// {@endtemplate}
class u extends StatelessComponent {
  /// {@macro jaspr.html.u}
  const u(
    this.children, {
    this.id,
...
/// {@endtemplate}
class wbr extends StatelessComponent {
