...
void main() {
  group('reorder children test', () {
    testComponents('should keep child state on reordering', (tester) async {
      ...
      var elements1 = (app.child as FragmentElement).children.whereType<ChildElement>().toList();
      ...
      var elements2 = (app.child as FragmentElement).children.whereType<ChildElement>().toList();
      ...
      var elements3 = (app.child as FragmentElement).children.whereType<ChildElement>().toList();
      ...
      var elements4 = (app.child as FragmentElement).children.whereType<ChildElement>().toList();
