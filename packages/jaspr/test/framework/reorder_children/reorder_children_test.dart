...
void main() {
  group('reorder children test', () {
    testComponents('should keep child state on reordering', (tester) async {
      ...
      final elements1 = app.children.whereType<ChildElement>().toList();
      ...
      final elements2 = app.children.whereType<ChildElement>().toList();
      ...
      final elements3 = app.children.whereType<ChildElement>().toList();
      ...
      final elements4 = app.children.whereType<ChildElement>().toList();
