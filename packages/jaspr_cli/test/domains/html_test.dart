...
void main() {
  ...
  test('element with attributes, id and class', () async {
  ...
  test('element with multiline text', () async {
  ...
  test('element with special attribute (a href)', () async {
  ...
  test('content of script and style tags is converted correctly', () async {
