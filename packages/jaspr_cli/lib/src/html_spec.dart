...
const htmlSpec = {
  "tags": {
    "content": {
      ...
      "dd": {
        "doc": "The &lt;dd&gt; HTML element provides the description, definition, or value for the preceding term (&lt;dt&gt;) in a description list (&lt;dl&gt;)."
      },
      "div": {
      ...
      "dl": {
        "doc": "The &lt;dl&gt; HTML element represents a description list. The element encloses a list of groups of terms (specified using the &lt;dt&gt; element) and descriptions (provided by &lt;dd&gt; elements). Common uses for this element are to implement a glossary or to display metadata (a list of key-value pairs)."
      },
      "dt": {
        "doc": "The &lt;dt&gt; HTML element specifies a term in a description or definition list, and as such must be used inside a &lt;dl&gt; element. It is usually followed by a &lt;dd&gt; element; however, multiple &lt;dt&gt; elements in a row indicate several terms that are all defined by the immediate next &lt;dd&gt; element.\n\nThe subsequent &lt;dd&gt; (Description Details) element provides the definition or other related text associated with the term specified using &lt;dt&gt;."
      },
      "ul": {
    ...
    "text": {
      "a": {
        ...
        "attributes": {
          ...
          "onClick": {
            "doc": "Callback for the 'click' event. This will override the default behavior of the link and not visit [href] when clicked.",
    ...
    "media": {
      ...
      "figure": {
        "doc": "The &lt;figure&gt; HTML element represents self-contained content, potentially with an optional caption, which is specified using the &lt;figcaption&gt; element. The figure, its caption, and its contents are referenced as a single unit."
      },
      "figcaption": {
    ...
    "other": {
      ...
      "script": {
        ...
        "attributes": {
          ...
          "content": {
            "doc": "The content of the script element, if it is not an external script.",
            "type": "content"
          }
        }
      }
