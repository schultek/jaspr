...
const htmlSpec = {
      ...
      "attributes": {
        ...
        "type": {
          ...
          "type": {
            ...
            "values": {
              "lowercaseLetters": {"value": "a", "doc": "For lowercase letters"},
              "uppercaseLetters": {"value": "A", "doc": "For uppercase letters"},
              "lowercaseRomanNumerals": {"value": "i", "doc": "For lowercase Roman numerals"},
              "uppercaseRomanNumerals": {"value": "I", "doc": "For uppercase Roman numerals"},
              "numbers": {"value": "1", "doc": "For numbers (default)"},
            },
          },
        },
      },
      ...
      "attributes": {
        ...
        "target": {
          ...
          "type": {
            ...
            "values": {
              "self": {"value": "_self", "doc": "The current browsing context. (Default)"},
              "blank": {
                "value": "_blank",
  ...
  "media": {
      ...
      "attributes": {
        ...
        "preload": {
          ...
          "type": {
            ...
            "values": {
              "none": {"doc": "Indicates that the audio should not be preloaded."},
              "metadata": {"doc": "Indicates that only audio metadata (e.g. length) is fetched."},
              "auto": {
                "doc":
    ...
    "img": {
      ...
      "self_closing": true,
      "attributes": {
        "alt": {"doc": "Defines an alternative text description of the image", "type": "string"},
        "crossorigin": {
          "name": "crossOrigin",
          "doc": "Indicates if the fetching of the image must be done using a CORS request.",
          "type": "enum:CrossOrigin",
        },
        "width": {"doc": "The intrinsic width of the image in pixels.", "type": "int"},
        "height": {"doc": "The intrinsic height of the image, in pixels.", "type": "int"},
        "loading": {
        ...
        "src": {"doc": "The image URL.", "type": "string", "required": true},
        "referrerpolicy": {
          "name": "referrerPolicy",
    ...
    "video": {
      ...
      "attributes": {
        ...
        "width": {"doc": "The width of the video's display area, in CSS pixels.", "type": "int"},
        "height": {"doc": "The height of the video's display area, in CSS pixels.", "type": "int"},
      },
    },
    "embed": {
      "doc":
      ...
      "self_closing": true,
      "attributes": {
        "src": {"doc": "The URL of the resource being embedded.", "type": "string", "required": true},
        "type": {"doc": "The MIME type to use to select the plug-in to instantiate.", "type": "string"},
        "width": {"doc": "The displayed width of the resource, in CSS pixels.", "type": "int"},
        "height": {"doc": "The displayed height of the resource, in CSS pixels.", "type": "int"},
      },
    },
    "iframe": {
      "doc":
      ...
      "attributes": {
        ...
        "csp": {"doc": "A Content Security Policy enforced for the embedded resource.", "type": "string"},
        "loading": {"doc": "Indicates how the browser should load the iframe.", "type": "enum:MediaLoading"},
        "name": {
          "doc":
        ...
        "referrerpolicy": {
          ...
          "type": {
            ...
            "values": {
              "noReferrer": {"value": "no-referrer", "doc": "The Referer header will not be sent."},
        ...
        "width": {"doc": "The width of the frame in CSS pixels. Default is 300.", "type": "int"},
        "height": {"doc": "The height of the frame in CSS pixels. Default is 150.", "type": "int"},
      },
    },
    "object": {
      "doc":
      ...
      "attributes": {
        ...
        "name": {"doc": "The name of valid browsing context (HTML5).", "type": "string"},
        "type": {
          "doc": "The content type of the resource specified by data. At least one of data and type must be defined.",
          "type": "string",
        },
        "width": {"doc": "The width of the displayed resource in CSS pixels.", "type": "int"},
        "height": {"doc": "The height of the displayed resource in CSS pixels.", "type": "int"},
      },
    },
    "source": {
      "doc":
      ...
      "self_closing": true,
      "attributes": {
        "type": {"doc": "The MIME media type of the resource, optionally with a codecs parameter.", "type": "string"},
        "src": {
          "doc":
  ...
  "forms": {
    "button": {
      ...
      "attributes": {
        ...
        "onClick": {"doc": "Callback for the 'click' event.", "type": "event:onClick:VoidCallback"},
      },
    },
    "form": {
      "doc":
      ...
      "attributes": {
        ...
        "method": {
          ...
          "type": {
            ...
            "values": {
              "post": {"doc": "The POST method; form data sent as the request body."},
              "get": {
                "doc":
        ...
        "enctype": {
          ...
          "type": {
            ...
            "values": {
              "formUrlEncoded": {"value": "application/x-www-form-urlencoded", "doc": "The default value"},
              "multiPart": {
                "value": "multipart/form-data",
                "doc": "Use this if the form contains &lt;input&gt; elements with type=file.",
              },
              "text": {"value": "text/plain", "doc": "Introduced by HTML5 for debugging purposes."},
            },
          },
        },
        "autocomplete": {
          ...
          "type": {
            ...
            "doc":
                "Indicates whether input elements can by default have their values automatically completed by the browser. autocomplete attributes on form elements override it on &lt;form&gt;.",
            "values": {
              "off": {"doc": "The browser may not automatically complete entries."},
              "on": {"doc": "The browser may automatically complete entries."},
            },
          },
        },
        "name": {
    ...
    "input": {
      ...
      "attributes": {
        "type": {
          ...
          "type": {
            ...
            "values": {
              ...
              "checkbox": {"doc": "A check box allowing single values to be selected/deselected."},
              "color": {
              ...
              "hidden": {"doc": "A control that is not displayed but whose value is submitted to the server."},
              "image": {
                "doc":
              ...
              "month": {"doc": "A control for entering a month and year, with no time zone."},
              "number": {
                "doc":
              ...
              "reset": {"doc": "A button that resets the contents of the form to default values. Not recommended."},
              "search": {
                "doc":
              ...
              "submit": {"doc": "A button that submits the form."},
              "tel": {
                "doc":
              ...
              "time": {"doc": "A control for entering a time value with no time zone."},
              "url": {
                "doc":
        ...
        "value": {"doc": "The value of the control.", "type": "string"},
        "disabled": {
          "doc":
    ...
    "select": {
      ...
      "attributes": {
        "name": {"doc": "This attribute is used to specify the name of the control.", "type": "string"},
        "value": {"doc": "The value of the control.", "type": "string"},
        "multiple": {
          "doc":
        ...
        "autocomplete": {"doc": "A string providing a hint for a user agent's autocomplete feature.", "type": "string"},
        "size": {
          "doc":
              "If the control is presented as a scrolling list box (e.g. when multiple is specified), this attribute represents the number of rows in the list that should be visible at one time. Browsers are not required to present a select element as a scrolled list box. The default value is 0.",
          "type": "int",
        },
        "onInput": {"doc": "Callback for the 'input' event.", "type": "event:onInput:ValueChanged<List<String>>"},
        "onChange": {"doc": "Callback for the 'change' event.", "type": "event:onChange:ValueChanged<List<String>>"},
      },
    },
    "fieldset": {
      "doc":
      ...
      "attributes": {
        "name": {"doc": "The name associated with the group.", "type": "string"},
        "disabled": {
          "doc":
    ...
    "textarea": {
      ...
      "attributes": {
        ...
        "name": {"doc": "The name of the control", "type": "string"},
        "placeholder": {
          "doc":
        ...
        "spellcheck": {
          ...
          "type": {
            ...
            "values": {
              ...
              "isFalse": {"value": "false", "doc": "Indicates that the element should not be spell checked."},
            },
          },
        },
        "wrap": {
        ...
        "onInput": {"doc": "Callback for the 'input' event.", "type": "event:onInput:ValueChanged<String>"},
        "onChange": {"doc": "Callback for the 'change' event.", "type": "event:onChange:ValueChanged<String>"},
      },
    },
  },
  "other": {
    ...
    "script": {
      ...
      "attributes": {
        ...
        "content": {"doc": "The content of the script element, if it is not an external script.", "type": "content"},
      },
    },
  },
  "svg": {
    "svg": {
      ...
      "attributes": {
        "viewBox": {"doc": "The SVG viewport coordinates for the current SVG fragment.", "type": "string"},
        "width": {
    ...
    ":shapes": {
      "fill": {"doc": "The color (or gradient or pattern) used to paint the shape.", "type": "css:Color"},
      "stroke": {
    ...
    "rect": {
      ...
      "attributes": {
        "x": {"doc": "The x coordinate of the rect.", "type": "string"},
        "y": {"doc": "The y coordinate of the rect.", "type": "string"},
        "rx": {"doc": "The horizontal corner radius of the rect.", "type": "string"},
        "ry": {"doc": "The vertical corner radius of the rect.", "type": "string"},
        "width": {"doc": "The width of the rect.", "type": "string"},
        "height": {"doc": "The height of the rect.", "type": "string"},
      },
      "inherit": "shapes",
    },
    "circle": {
      ...
      "attributes": {
        "cx": {"doc": "The x-axis coordinate of the center of the circle.", "type": "string"},
        "cy": {"doc": "The y-axis coordinate of the center of the circle.", "type": "string"},
        "r": {"doc": "The radius of the circle.", "type": "string"},
      },
      "inherit": "shapes",
    },
    "ellipse": {
      ...
      "attributes": {
        "cx": {"doc": "The x-axis coordinate of the center of the ellipse.", "type": "string"},
        "cy": {"doc": "The y-axis coordinate of the center of the ellipse.", "type": "string"},
        "rx": {"doc": "The radius of the ellipse on the x axis.", "type": "string"},
        "ry": {"doc": "The radius of the ellipse on the y axis.", "type": "string"},
      },
      "inherit": "shapes",
    },
    "line": {
      ...
      "attributes": {
        "x1": {"doc": "Defines the x-axis coordinate of the line starting point.", "type": "string"},
        "y1": {"doc": "Defines the y-axis coordinate of the line starting point.", "type": "string"},
        "x2": {"doc": "Defines the x-axis coordinate of the line ending point.", "type": "string"},
        "y2": {"doc": "Defines the y-axis coordinate of the line ending point.", "type": "string"},
      },
      "inherit": "shapes",
    },
    "path": {
      ...
      "attributes": {
        "d": {"doc": "This attribute defines the shape of the path.", "type": "string"},
      },
      "inherit": "shapes",
    },
    "polygon": {
