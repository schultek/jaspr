 ...
 */
class SegmentedButton extends s {
    constructor() {
        super(...arguments);
        this.disabled = false;
        this.selected = false;
    ...
    render() {
      ...
      <button
        ...
        class="md3-segmented-button ${e(this.getRenderClasses())}">
        <md-focus-ring
...
__decorate([
    n$1({ type: Boolean, attribute: 'no-checkmark' })
], SegmentedButton.prototype, "noCheckmark", void 0);
__decorate([
    n$1({ type: Boolean, attribute: 'has-icon' })
...
MdOutlinedSegmentedButton.styles = [styles, styles$1];
MdOutlinedSegmentedButton = __decorate([
    t$3('md-outlined-segmented-button')
