 ...
 */
class SegmentedButtonSet extends s {
    constructor() {
        super(...arguments);
...
MdOutlinedSegmentedButtonSet.styles = [styles, styles$1];
MdOutlinedSegmentedButtonSet = __decorate([
    t$2('md-outlined-segmented-button-set')
