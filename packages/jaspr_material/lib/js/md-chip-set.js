 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function o$1(o){return (e,n)=>{const{slot:r,selector:s}={},c="slot"+(r?`[name=${r}]`:":not([name])");return e$4(e,n,{get(){const t=this.renderRoot?.querySelector(c),e=t?.assignedElements(o)??[];return void 0===s?e:e.filter((t=>t.matches(s)))}})}}
...
const styles = i$3 `:host{display:flex;flex-wrap:wrap;gap:8px}
`;
