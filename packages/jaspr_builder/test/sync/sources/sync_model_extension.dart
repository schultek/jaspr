...
final syncModelExtensionOutputs = {
  'site|lib/component.sync.dart':
      ...
      '    m = value[\'m\'] != null\n'
      '        ? _model_extension.ModelBCodec.fromRaw(value[\'m\']!)\n'
      '        : null;\n'
      '    m2 = _model_extension.ModelBCodec.fromRaw(value[\'m2\']);\n'
      '    m3 = (value[\'m3\'] as List<dynamic>)\n'
      '        .map((i) => _model_extension.ModelBCodec.fromRaw(i))\n'
      '        .toList();\n'
      '    m4 = (value[\'m4\'] as List<dynamic>)\n'
      '        .map((i) => i != null ? _model_extension.ModelBCodec.fromRaw(i!) : null)\n'
      '        .toList();\n'
      '    m5 = (value[\'m5\'] as Map<String, dynamic>).map(\n'
      '      (k, v) => MapEntry(k, _model_extension.ModelBCodec.fromRaw(v)),\n'
      '    );\n'
      '    m6 = (value[\'m6\'] as Map<String, dynamic>).map(\n'
      '      (k, v) => MapEntry(\n'
      '        k,\n'
      '        v != null ? _model_extension.ModelBCodec.fromRaw(v!) : null,\n'
      '      ),\n'
      '    );\n'
      '  }\n'
      '\n'
