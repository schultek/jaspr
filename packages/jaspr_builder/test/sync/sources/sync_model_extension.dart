...
final syncModelExtensionOutputs = {
  'site|lib/component.sync.dart': '// dart format off\n'
      ...
      '    m = value[\'m\'] != null ? prefix1.ModelBCodec.fromRaw(value[\'m\']!) : null;\n'
      '    m2 = prefix1.ModelBCodec.fromRaw(value[\'m2\']);\n'
      '    m3 =\n'
      '        (value[\'m3\'] as List<dynamic>)\n'
      '            .map((i) => prefix1.ModelBCodec.fromRaw(i))\n'
      '            .toList();\n'
      '    m4 =\n'
      '        (value[\'m4\'] as List<dynamic>)\n'
      '            .map((i) => i != null ? prefix1.ModelBCodec.fromRaw(i!) : null)\n'
      '            .toList();\n'
      '    m5 = (value[\'m5\'] as Map<String, dynamic>).map(\n'
      '      (k, v) => MapEntry(k, prefix1.ModelBCodec.fromRaw(v)),\n'
      '    );\n'
      '    m6 = (value[\'m6\'] as Map<String, dynamic>).map(\n'
      '      (k, v) => MapEntry(k, v != null ? prefix1.ModelBCodec.fromRaw(v!) : null),\n'
      '    );\n'
      '  }\n'
      '\n'
      '  @override\n'
