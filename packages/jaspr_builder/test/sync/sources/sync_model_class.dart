...
final syncModelClassOutputs = {
  'site|lib/component.sync.dart':
      ...
      '        ? prefix1.ModelA.fromRaw((value[\'m\'] as Map<String, dynamic>)!)\n'
      '        : null;\n'
      '    m2 = prefix1.ModelA.fromRaw((value[\'m2\'] as Map<String, dynamic>));\n'
      ...
      '        .map((k, v) => MapEntry(k, prefix1.ModelA.fromRaw(v)));\n'
