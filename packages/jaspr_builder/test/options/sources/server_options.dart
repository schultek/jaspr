...
final serverOptionsOutputs = {
  'site|lib/main.server.g.dart':
      ...
      '    ),\n'
      '    \$component_model_extension.Component:\n'
      '        ClientTarget<\$component_model_extension.Component>(\n'
      '          \'component_model_extension\',\n'
      '          params: _\$component_model_extensionComponent,\n'
      '        ),\n'
      '  },\n'
