...
final serverOptionsOtherOutputs = {
  'site|lib/other.server.g.dart':
      ...
      'import \'package:site/component_basic.dart\' as \$component_basic;\n'
      'import \'package:site/component_model_class.dart\' as \$component_model_class;\n'
      'import \'package:site/styles_global.dart\' as \$styles_global;\n'
      '\n'
      ...
      '  clients: {\n'
      '    \$component_basic.Component: ClientTarget<\$component_basic.Component>(\n'
      '      \'component_basic\',\n'
      '      params: _\$component_basicComponent,\n'
      '    ),\n'
      '    \$component_model_class.Component:\n'
      '        ClientTarget<\$component_model_class.Component>(\n'
      '          \'component_model_class\',\n'
      '          params: _\$component_model_classComponent,\n'
      '        ),\n'
      '  },\n'
