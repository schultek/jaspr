...
class Element {
  ...
  dynamic querySelectorAll(String selectors) => throw UnimplementedError('querySelectorAll');
  dynamic setApplyScroll(String nativeScrollBehavior) => throw UnimplementedError('setApplyScroll');
  dynamic setDistributeScroll(String nativeScrollBehavior) => throw UnimplementedError('setDistributeScroll');
  ...
  dynamic getClientRects() => throw UnimplementedError('getClientRects');
  ...
  dynamic offsetTo(Element parent) => throw UnimplementedError('offsetTo');
  ...
  dynamic getAnimations() => throw UnimplementedError('getAnimations');
  List<String> getAttributeNames() => throw UnimplementedError('getAttributeNames');
  dynamic getBoundingClientRect() => throw UnimplementedError('getBoundingClientRect');
  dynamic getDestinationInsertionPoints() => throw UnimplementedError('getDestinationInsertionPoints');
  dynamic getElementsByClassName(String classNames) => throw UnimplementedError('getElementsByClassName');
  ...
  dynamic get client => throw UnimplementedError('client');
  dynamic get offset => throw UnimplementedError('offset');
  ...
  dynamic get documentOffset => throw UnimplementedError('documentOffset');
  ...
  void insertAllBefore(dynamic newNodes, dynamic child) => throw UnimplementedError('insertAllBefore');
  ...
  dynamic get nodes => throw UnimplementedError('nodes');
  set nodes(dynamic _) => throw UnimplementedError('nodes=');
  dynamic get childNodes => throw UnimplementedError('childNodes');
  ...
  Document? get ownerDocument => throw UnimplementedError('ownerDocument');
  ...
  void addEventListener(String type, dynamic Function(dynamic) listener, [bool? useCapture]) =>
      throw UnimplementedError('addEventListener');
  void removeEventListener(String type, dynamic Function(dynamic) listener, [bool? useCapture]) =>
      throw UnimplementedError('removeEventListener');
  bool dispatchEvent(dynamic event) => throw UnimplementedError('dispatchEvent');
...
class Document {
  ...
  dynamic getAnimations() => throw UnimplementedError('getAnimations');
  dynamic getElementsByClassName(String classNames) => throw UnimplementedError('getElementsByClassName');
  dynamic getElementsByName(String elementName) => throw UnimplementedError('getElementsByName');
  dynamic getElementsByTagName(String localName) => throw UnimplementedError('getElementsByTagName');
  ...
  Function registerElement2(String type, [Map<dynamic, dynamic>? options]) =>
  ...
  static dynamic get pointerLockChangeEvent => throw UnimplementedError('pointerLockChangeEvent');
  static dynamic get pointerLockErrorEvent => throw UnimplementedError('pointerLockErrorEvent');
  static dynamic get readyStateChangeEvent => throw UnimplementedError('readyStateChangeEvent');
  static dynamic get securityPolicyViolationEvent => throw UnimplementedError('securityPolicyViolationEvent');
  static dynamic get selectionChangeEvent => throw UnimplementedError('selectionChangeEvent');
  ...
  dynamic get onPlay => throw UnimplementedError('onPlay');
  dynamic get onPlaying => throw UnimplementedError('onPlaying');
  dynamic get onPointerLockChange => throw UnimplementedError('onPointerLockChange');
  dynamic get onPointerLockError => throw UnimplementedError('onPointerLockError');
  dynamic get onRateChange => throw UnimplementedError('onRateChange');
  dynamic get onReadyStateChange => throw UnimplementedError('onReadyStateChange');
  dynamic get onReset => throw UnimplementedError('onReset');
  dynamic get onResize => throw UnimplementedError('onResize');
  dynamic get onScroll => throw UnimplementedError('onScroll');
  dynamic get onSearch => throw UnimplementedError('onSearch');
  dynamic get onSecurityPolicyViolation => throw UnimplementedError('onSecurityPolicyViolation');
  dynamic get onSeeked => throw UnimplementedError('onSeeked');
  dynamic get onSeeking => throw UnimplementedError('onSeeking');
  dynamic get onSelect => throw UnimplementedError('onSelect');
  dynamic get onSelectionChange => throw UnimplementedError('onSelectionChange');
  dynamic get onSelectStart => throw UnimplementedError('onSelectStart');
  dynamic get onStalled => throw UnimplementedError('onStalled');
  dynamic get onSubmit => throw UnimplementedError('onSubmit');
  dynamic get onSuspend => throw UnimplementedError('onSuspend');
...
class HtmlDocument {
  ...
  dynamic get styleSheets => throw UnimplementedError('styleSheets');
  String get title => throw UnimplementedError('title');
  set title(String _) => throw UnimplementedError('title=');
  dynamic get onVisibilityChange => throw UnimplementedError('onVisibilityChange');
  dynamic adoptNode(dynamic node) => throw UnimplementedError('adoptNode');
  dynamic createDocumentFragment() => throw UnimplementedError('createDocumentFragment');
  dynamic createRange() => throw UnimplementedError('createRange');
  bool execCommand(String commandId, [bool? showUI, String? value]) => throw UnimplementedError('execCommand');
...
class Window {
  ...
  dynamic requestFileSystem(int size, {bool persistent = false}) => throw UnimplementedError('requestFileSystem');
  ...
  dynamic getMatchedCssRules(Element? element, String? pseudoElement) => throw UnimplementedError('getMatchedCssRules');
  ...
  dynamic resolveLocalFileSystemUrl(String url) => throw UnimplementedError('resolveLocalFileSystemUrl');
  String atob(String atob) => throw UnimplementedError('atob');
  String btoa(String btoa) => throw UnimplementedError('btoa');
  void moveTo(dynamic p) => throw UnimplementedError('moveTo');
  ...
  Document get document => throw UnimplementedError('document');
  ...
  dynamic get history => throw UnimplementedError('history');
  ...
  dynamic get localStorage => throw UnimplementedError('localStorage');
  ...
  dynamic get sessionStorage => throw UnimplementedError('sessionStorage');
  ...
  dynamic get window => throw UnimplementedError('window');
  dynamic get onContentLoaded => throw UnimplementedError('onContentLoaded');
  dynamic get onAbort => throw UnimplementedError('onAbort');
  dynamic get onBlur => throw UnimplementedError('onBlur');
  dynamic get onCanPlay => throw UnimplementedError('onCanPlay');
  dynamic get onCanPlayThrough => throw UnimplementedError('onCanPlayThrough');
  ...
  dynamic get onContextMenu => throw UnimplementedError('onContextMenu');
  dynamic get onDoubleClick => throw UnimplementedError('onDoubleClick');
  dynamic get onDeviceMotion => throw UnimplementedError('onDeviceMotion');
  dynamic get onDeviceOrientation => throw UnimplementedError('onDeviceOrientation');
  dynamic get onDrag => throw UnimplementedError('onDrag');
  dynamic get onDragEnd => throw UnimplementedError('onDragEnd');
  dynamic get onDragEnter => throw UnimplementedError('onDragEnter');
  dynamic get onDragLeave => throw UnimplementedError('onDragLeave');
  ...
  dynamic get onError => throw UnimplementedError('onError');
  dynamic get onFocus => throw UnimplementedError('onFocus');
  dynamic get onHashChange => throw UnimplementedError('onHashChange');
  dynamic get onInput => throw UnimplementedError('onInput');
  dynamic get onInvalid => throw UnimplementedError('onInvalid');
  dynamic get onKeyDown => throw UnimplementedError('onKeyDown');
  dynamic get onKeyPress => throw UnimplementedError('onKeyPress');
  ...
  dynamic get onLoadedData => throw UnimplementedError('onLoadedData');
  dynamic get onLoadedMetadata => throw UnimplementedError('onLoadedMetadata');
  dynamic get onLoadStart => throw UnimplementedError('onLoadStart');
  dynamic get onMessage => throw UnimplementedError('onMessage');
  dynamic get onMouseDown => throw UnimplementedError('onMouseDown');
  dynamic get onMouseEnter => throw UnimplementedError('onMouseEnter');
  dynamic get onMouseLeave => throw UnimplementedError('onMouseLeave');
  dynamic get onMouseMove => throw UnimplementedError('onMouseMove');
  ...
  dynamic get onMouseUp => throw UnimplementedError('onMouseUp');
  dynamic get onMouseWheel => throw UnimplementedError('onMouseWheel');
  dynamic get onOffline => throw UnimplementedError('onOffline');
  dynamic get onOnline => throw UnimplementedError('onOnline');
  dynamic get onPageHide => throw UnimplementedError('onPageHide');
  dynamic get onPageShow => throw UnimplementedError('onPageShow');
  dynamic get onPause => throw UnimplementedError('onPause');
  dynamic get onPlay => throw UnimplementedError('onPlay');
  dynamic get onPlaying => throw UnimplementedError('onPlaying');
  dynamic get onPopState => throw UnimplementedError('onPopState');
  dynamic get onProgress => throw UnimplementedError('onProgress');
  dynamic get onRateChange => throw UnimplementedError('onRateChange');
  dynamic get onReset => throw UnimplementedError('onReset');
  dynamic get onResize => throw UnimplementedError('onResize');
  dynamic get onScroll => throw UnimplementedError('onScroll');
  ...
  dynamic get onSelect => throw UnimplementedError('onSelect');
  dynamic get onStalled => throw UnimplementedError('onStalled');
  dynamic get onStorage => throw UnimplementedError('onStorage');
  dynamic get onSubmit => throw UnimplementedError('onSubmit');
  dynamic get onSuspend => throw UnimplementedError('onSuspend');
  dynamic get onTimeUpdate => throw UnimplementedError('onTimeUpdate');
  dynamic get onTouchCancel => throw UnimplementedError('onTouchCancel');
  ...
  dynamic get onTouchStart => throw UnimplementedError('onTouchStart');
  dynamic get onTransitionEnd => throw UnimplementedError('onTransitionEnd');
  dynamic get onUnload => throw UnimplementedError('onUnload');
  dynamic get onVolumeChange => throw UnimplementedError('onVolumeChange');
  dynamic get onWaiting => throw UnimplementedError('onWaiting');
  dynamic get onAnimationEnd => throw UnimplementedError('onAnimationEnd');
  dynamic get onAnimationIteration => throw UnimplementedError('onAnimationIteration');
  dynamic get onAnimationStart => throw UnimplementedError('onAnimationStart');
  dynamic get onBeforeUnload => throw UnimplementedError('onBeforeUnload');
  dynamic get onWheel => throw UnimplementedError('onWheel');
...
Future<String> someTopFunction(SomeInterface interface, {int? v}) => throw UnimplementedError('someTopFunction');

class SomeInterface {
  void doSomething(String param) => throw UnimplementedError('doSomething');
  static void oha() => throw UnimplementedError('oha');
  int get value => throw UnimplementedError('value');
  set value(int _) => throw UnimplementedError('value=');
  static bool get isTop => throw UnimplementedError('isTop');
  static set isTop(bool _) => throw UnimplementedError('isTop=');
}
