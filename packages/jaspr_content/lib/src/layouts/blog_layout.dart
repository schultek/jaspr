...
class BlogLayout extends PageLayoutBase {
  const BlogLayout({this.header, this.textFont = _defaultTextFont});
  ...
  Iterable<Component> buildHead(Page page) sync* {
    ...
    yield Style(
      styles: [
        ..._styles,
        css('.blog .content', [
          css('&').styles(fontSize: 1.125.rem, lineHeight: 2.rem),
          css('> :not(:is(h1,h2,h3,h4,h5,h6))').styles(fontFamily: textFont),
        ]),
      ],
    );
  }
  ...
  static List<StyleRule> get _styles => [
    css('.blog', [
      ...
      css('.main-container', [
        css('&').styles(padding: Padding.zero),
