...
final List<StyleRule> _contentStyles = [
  ...
  css('ol > li::marker').styles(color: ContentColors.counters, fontWeight: FontWeight.w400),
  ...
  css('h1 strong').styles(color: Color.inherit, fontWeight: FontWeight.w900),
  css('h2').styles(color: ContentColors.headings, fontWeight: FontWeight.w700),
  css('h2 strong').styles(color: Color.inherit, fontWeight: FontWeight.w800),
  css('h3').styles(color: ContentColors.headings, fontWeight: FontWeight.w600),
  css('h3 strong').styles(color: Color.inherit, fontWeight: FontWeight.w700),
  css('h4').styles(color: ContentColors.headings, fontWeight: FontWeight.w600),
  css('h4 strong').styles(color: Color.inherit, fontWeight: FontWeight.w700),
  css('picture').styles(display: Display.block),
  css('kbd').styles(color: ContentColors.kbd, fontFamily: FontFamily.inherit, fontWeight: FontWeight.w500),
