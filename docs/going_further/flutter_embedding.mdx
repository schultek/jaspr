...
New projects can be setup with Flutter embedding using `jaspr create`. For existing projects, the `jaspr new component --flutter` command performs all of the steps above for you.
