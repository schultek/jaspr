...
With Jaspr loading data like this on the server and also syncing it with the client is built into the core framework, and you have a couple of options to choose from.
...
### Using @sync on fields of a StatefulComponent's State
