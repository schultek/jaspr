...
Note: There is no additional step to add Flutter support. After it's been deployed a Page Not Found page from Firebase may be shown initially but afterwards your website will be shown.
