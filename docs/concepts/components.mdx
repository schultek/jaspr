...
<Info>
Since Dart 3.10 you can use dot-shorthands to shorten the syntax of text components: `.text('Hello World')` instead of `Component.text('Hello World')`.
</Info>
...
<Info>
Since Dart 3.10 you can use dot-shorthands to shorten the syntax of fragment components: `.fragment([ ... ])` instead of `Component.fragment([ ... ])`.
</Info>
