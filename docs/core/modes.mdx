...
- **Static Mode**
  ...
  Read more about (**Static Site Generation**](/core/ssg).
...
| **Client-side rendering** / **Interactivity** | Yes (with [Hydration](#hydration)) | Yes (with [Hydration](#hydration)) | Yes        |
...
Read more on `@client` components, their features and best-practices [here](/core/at_client).
