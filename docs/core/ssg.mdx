---
title: Jaspr Static Site Generationn
...
<Info>
Routes with path parameters are currently not supported, since all routes need to be resolvable when initializing the router.
</Info>

## Manual usage

If you want to set this up manually, you need to call `ServerApp.requestRouteGeneration('/my_route');` for any of your routes.
