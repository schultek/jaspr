...
- check out [the server_handling example](https://github.com/schultek/jaspr/tree/main/examples/shelf_backend) to see this in action.
...
Check out [the shelf_handler example](https://github.com/schultek/jaspr/tree/main/examples/custom_server_middleware) to see this in action.
