...
description: Understand the difference between client vs server rendering.
---
...
2. You can use the `@Import` annotation to import the correct library depending on the environment. This is a shorthand for using [conditional imports](https://dart.dev/guides/libraries/create-packages#conditionally-importing-and-exporting-library-files) and is the recommended way to do this in Jaspr.
...
- [`@client`](/utils/at_client)
- [`@Import`](/utils/at_import)
