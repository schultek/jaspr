...
How your website is served depends on your selected [**Rendering Mode**](/concepts/modes):
...
This will build the app inside the `build/jaspr/` directory according to your selected [**Rendering Mode**](/concepts/modes):
...
<Tabs groupId="mode">
  <TabItem label="Static Mode" value="static">
    ...
    Learn more about generating static sites [here](/concepts/static_sites).
  </TabItem>
