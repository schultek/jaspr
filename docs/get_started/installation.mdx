...
<Tabs groupId="installation" defaultValue="vscode">
  <Tab label="VSCode Extension" value="vscode">
    <Steps>
  ...
  <Tab title="Jaspr CLI" value="cli">
    <Steps>
      ...
      <Step title="Create a Project">
        ...
        The cli will prompt you with a set of options to configure your project. You can read about what each option does [below](/get_started/installation#project-options) or just start with the recommended ones (simply press **Enter** each time).
...
<Tabs groupId="installation">
  <Tab label="VSCode Extension" value="vscode">
    When creating a new project through the **Jaspr VSCode Extension**, you can choose from a predefines set of templates.
  </Tab>
  <Tab label="Jaspr CLI" value="cli">
    ...
    <Property name="Hydration" type="conditional">
      Select the hydration strategy (automatic or manual). Read about hydration [here](/get_started/hydration).
    </Property>
