...
A pure client-side app without ssr. Requires the `--no-ssr` flag to be passed to 
both `jaspr serve` and `jaspr build`. Allows your site to be deployed to a static file hosting
