...
All modes support client-side interactivity and can be used to build interactive web applications. The main difference is when and how the initial HTML is generated. Read more about rendering modes [here](concepts/modes).
...
<Tabs groupId="tooling">
  ...
  <TabItem label="Jaspr CLI" value="cli">
    ...
    The cli will prompt you with a set of options to configure your project. You can read about what each option does [here](get_started/cli#creating-a-new-project) or just start with the recommended ones (simply press **Enter** each time).
...
- []
[Concepts](concepts/overview): Learn about the core concepts of Jaspr.
- [Tutorials](tutorials/overview): Follow step-by-step tutorials to build more complex applications.
- [API Reference](api/overview): Explore the API reference for Jaspr.
