...
class HomeScreen extends StatelessWidget {
  ...
  "name": "Smart Watch",
  "price": 50,
  "image": "https://linktoimage.com/watch.png",
  "category": "Electronics"
}flutter_stripe: ^8.0.0flutter build apk --release---import 'package:flutter/material.dart';
...
class ShopMarkApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'ShopMark',
...
title: Quickstart
description: Get stlarted with Jaspr and build your first website in Dart.
---
