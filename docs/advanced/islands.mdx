...
Jaspr supports this architecture out of the box by allowing **multiple parallel apps** on the client.
...
## Automatic setup of island components

Jaspr makes this even more convenient by giving you automated builders that set this up for you.
