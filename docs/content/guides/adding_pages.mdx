...
Instead of creating these files by hand, you can also use the `jaspr new page` command, which creates the file in your content directory and fills in the frontmatter for you:

```shell
jaspr new page posts/post3
```
