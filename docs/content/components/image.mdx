...
To use the `<Image>` component, add it to your `components` list in your `main.dart` file:
...
```jsx
<Image src="https://placehold.co/600x400" alt="Sample Image" caption="This is a sample image." />
```
...
```jsx
<Image src="https://placehold.co/600x400" alt="Sample Image" zoom />
```
