...
<Image src="/content/layouts/docs_dark.png" zoom theme="light" width="600" caption="Docs Layout (Dark Theme)" />
<Image src="/content/layouts/docs_light.png" zoom theme="dark" width="600" caption="Docs Layout (Light Theme)" />
