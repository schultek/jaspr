...
With [GitHub Pages](https://pages.github.com/) you can automatically deploy your site when you push to a configured repository
...
<Info>
  ...
  guide](https://docs.github.com/en/pages/getting-started-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site#publishing-with-a-custom-github-actions-workflow)
...
4. Edit the default workflow script to the following:
   1. After the "Setup Pages" step, add the following two steps:
      ```yaml
      - name: 'Setup Dart'
...
If you are deploying from any other repository, the site's URL will be `http://<username>.github.io/<repository>`. For this
