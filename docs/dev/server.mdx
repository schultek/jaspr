...
The counterpart to this is the "client" environment, which is either the JavaScript or WASM runtime in the browser that is displaying your website. All interactivity, event handlers, and access to browser APIs needs to happen in the client environment.
