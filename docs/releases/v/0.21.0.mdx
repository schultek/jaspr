...
## New Component Scopes in VSCode

The newest version of the VSCode extension, released together with Jaspr 0.21.0, contains a big quality-of-life feature to help navigate the complexities of writing full-stack components: Component Scopes
